...
//Kasi credit gw DappaUhuy

//dan juga Subscribe DappaUhuy jgn cuma ganti nama bot
...
//CASE BADWORD
	...
	if (!isRegistered) return reply(ind.noregis())
           ...
           client.sendMessage(from, buffer, image, {quoted: mek, caption: '*LOLI IS MY LIFE*'})
		await limitAdd(sender)
           break
		case 'waifu':
                        if (!isRegistered) return reply(ind.noregis())
		...
		case 'dadu':
			...
			break
				...
				reply(ind.wait())
                 ...
                 client.sendMessage(from, darkjokes, image, {quoted: mek, caption: '\`\`\`LAMPU MANA LAMPU?\`\`\`'})
				await limitAdd(sender)
				break
			case 'asupan':
				client.updatePresence(from, Presence.composing) 
			...
			if (args.length < 1) return reply(ind.wrongf())
				...
				break
case 'iri':
const irimp3 = fs.readFileSync('./subsdappauhuy/assets/iri.mp3');
client.sendMessage(from, irimp3, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'pale':
const pa = fs.readFileSync('/subsdappauhuy/assets/pale.mp3')
client.sendMessage(from, pa, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound':
const soun = fs.readFileSync('/subsdappauhuy/assets/sound.mp3')
client.sendMessage(from, soun, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break 
case 'sound1':
satu = fs.readFileSync('./subsdappauhuy/assets/sound1.mp3');
client.sendMessage(from, satu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound2':
dua = fs.readFileSync('./subsdappauhuy/assets/sound2.mp3');
client.sendMessage(from, dua, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound3':
tiga = fs.readFileSync('./subsdappauhuy/assets/sound3.mp3');
client.sendMessage(from, tiga, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound4':
empat = fs.readFileSync('./subsdappauhuy/assets/sound4.mp3');
client.sendMessage(from, empat, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound5':
lima = fs.readFileSync('./subsdappauhuy/assets/sound5.mp3');
client.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound6':
enam = fs.readFileSync('./subsdappauhuy/assets/sound6.mp3');
client.sendMessage(from, enam, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound7':
tujuh = fs.readFileSync('./subsdappauhuy/assets/sound7.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break 
case 'sound8':
satu = fs.readFileSync('./subsdappauhuy/assets/sound8.mp3');
client.sendMessage(from, satu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound9':
 dua = fs.readFileSync('/subsdappauhuy/assets/sound9.mp3')
client.sendMessage(from, dua, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound10':
 tiga  = fs.readFileSync('/subsdappauhuy/assets/sound10.mp3')
client.sendMessage(from, tiga, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break 
case 'sound11':
satu  = fs.readFileSync('./subsdappauhuy/assets/sound11.mp3');
client.sendMessage(from, satu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound12':
dua   = fs.readFileSync('./subsdappauhuy/assets/sound12.mp3');
client.sendMessage(from, dua, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound13':
tiga   = fs.readFileSync('./subsdappauhuy/assets/sound13.mp3');
client.sendMessage(from, tiga, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound14':
empat   = fs.readFileSync('./subsdappauhuy/assets/sound14.mp3');
client.sendMessage(from, empat, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound15':
lima   = fs.readFileSync('./subsdappauhuy/assets/sound15.mp3');
client.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound16':
enam   = fs.readFileSync('./subsdappauhuy/assets/sound16.mp3');
client.sendMessage(from, enam, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound17':
tujuh   = fs.readFileSync('./subsdappauhuy/assets/sound17.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break 
case 'sound18':
satu   = fs.readFileSync('./subsdappauhuy/assets/sound18.mp3');
client.sendMessage(from, satu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound19':
dua   = fs.readFileSync('/subsdappauhuy/assets/sound19.mp3')
client.sendMessage(from, dua, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound20':
tiga = fs.readFileSync('/subsdappauhuy/assets/sound20.mp3')
client.sendMessage(from, tiga, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break 
case 'sound21':
empat  = fs.readFileSync('./subsdappauhuy/assets/sound21.mp3');
client.sendMessage(from, satu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound22':
lima = fs.readFileSync('./subsdappauhuy/assets/sound22.mp3');
client.sendMessage(from, dua, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound23':
enam = fs.readFileSync('./subsdappauhuy/assets/sound23.mp3');
client.sendMessage(from, tiga, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound24':
tujuh = fs.readFileSync('./subsdappauhuy/assets/sound24.mp3');
client.sendMessage(from, empat, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'odading':
tujuh = fs.readFileSync('./subsdappauhuy/assets/odading.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break				     		
case 'hartatahta':
if (!isRegistered) return reply(ind.noregis())
...
break
			...
			if (isLimit(sender)) return reply(ind.limitend(pusname))
				...
				if (!isGroup) return reply(ind.groupo()) 
					...
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=bokep&apikey=dapppbotwa`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
			...
			case 'pornhub':
				...
				var porn = gh.split("&")[0];
				var hub = gh.split("&")[1];
				if (args.length < 1) return reply(`「❗」Contoh : ${prefix}pornhub Dappa & Hub`)
				reply(ind.wait())
	  ...
	  case 'seberapagay':
		...
		case 'apiteks':
				...
				if (isLimit(sender)) return reply(limitend(pushname))
					...
					client.sendMessage(from, bufferxcz, image, {quoted: mek, caption: 'subs DappaUhuy'})
					break
		case 'infogempa':
               if (!isRegistered) return reply(ind.noregis())
               if (isLimit(sender)) return reply(limitend(pushname2))
	...
	case 'hobby':
		...
		if (isLimit(sender)) return reply(ind.limitend(pusname)) 
			...
			if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					bufasfer = await getBuffer(`https://api.vhtear.com/galaxytext?text=${teks}&apikey=dapppbotwa`, {method: 'get'})
            ...
            case 'creator':
                  ...
                  client.sendMessage(from, 'Tuh kontak DappaGanz <•_•> ,Jangan Lupa Save Ya (*>*)',MessageType.text, { quoted: mek} )
		const DAPPAGANTENG = fs.readFileSync('./dappauhuy/DAPPAGANTENG');
                client.sendMessage(from, DAPPAGANTENG, MessageType.image, {quoted: mek, caption: '*INI OWNER GW DAPPA GANTENG KAN😎*'})
                 break
		break    
           	case 'setname':
                if (!isGroup) return reply(ind.groupo())
		...
		if (budy.includes(`bot`)) {
                  reply(`Iya DapBOT~ disini ketik #help ya kak`)
